...
public class AbebeWeightedGraph<V>extends AbebeUnweightedGraph<V> {
	public AbebeWeightedGraph() {
	}

	public AbebeWeightedGraph(V[] vertices, int[][] edges) {
		createWeightedGraph(java.util.Arrays.asList(vertices), edges);
	}

	public AbebeWeightedGraph(int[][] edges, int numberOfVertices) {
	...
	public AbebeWeightedGraph(List<V> vertices, List<WeightedEdge> edges) {
		createWeightedGraph(vertices, edges);
	}

	public AbebeWeightedGraph(List<WeightedEdge> edges,
